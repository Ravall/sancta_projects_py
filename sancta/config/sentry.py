...
if DEBUG:
    ...
    SENTRY_URL_PREFIX = 'http://sentry.sancta.ru'
    ALLOWED_HOSTS = ['sentry.sancta.ru']
...
SECRET_KEY = 'FeE5KK+Cg8HFpODeqkguGCVsffuCoSPKUq//9iUO9lcSm9FVuKh7Ug=='
...
# нужно добавить дабы не возникала
