...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        if not is_table_exists(dbs['sancta_db'], 'api_nofify_email'):
            dbs['sancta_db'].create_table('api_nofify_email', (
    ...
    def backwards(self, orm):
        if is_table_exists(dbs['sancta_db'], 'api_nofify_email'):
            dbs['sancta_db'].delete_table('api_nofify_email')
